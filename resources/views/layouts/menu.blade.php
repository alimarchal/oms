<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('dashboard')}}" class="brand-link">
        <img src="{{\Illuminate\Support\Facades\Storage::url('CUI_Logo_low.png')}}" alt="COMSAT Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">COMSAT</span>
    </a>
